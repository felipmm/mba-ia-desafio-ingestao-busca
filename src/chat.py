...
def main():
    ...
    print("-" * 72)
    print("| Chat sobre Iron Maiden e Historias de algumas Receitas Tradicionais  | ")
    print("-" * 72)
    print("| Abaixo você pode integarir com o chat ou digitar 'quit' para encerrar| ")
    print("-" * 72)

    while True:
        user_question = input("Conversa: ").strip()
